...
import { useUpdateAccount } from '../../../hooks/useFinanceData';
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-6 mt-2">
                ...
                <div className="pt-4 flex justify-end gap-3 border-t border-border mt-6">
                    <Button type="button" variant="ghost" onClick={onClose} disabled={updateAccount.isPending} className="min-h-[44px] md:min-h-0">
                        Cancel
                    </Button>
                    <Button type="submit" disabled={updateAccount.isPending || !name || !type || !initialBalance} className="min-h-[44px] md:min-h-0">
